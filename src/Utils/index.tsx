...
//         if (refresh) {
//             try {
//                 const response = await fetch('https://x-clone-backend-cyan.vercel.app/api/token/refresh/', {
//                     method: 'POST',
...
const validateToken = async (accessToken: any) => {
    ...
    try {
        const response = await fetch('https://x-clone-backend-cyan.vercel.app/api/token/validate/', {
            method: 'POST',
            headers: {
